...
List<NameOfAllahModel> nameOfAllahModelFromJson(String str) =>
    List<NameOfAllahModel>.from(
        json.decode(str).map((x) => NameOfAllahModel.fromJson(x)));

String nameOfAllahModelToJson(List<NameOfAllahModel> data) =>
