class HajjLiveConfig {
  static const String githubConfigUrl =
      'https://raw.githubusercontent.com/arhamsarwar786/hajj-json-IQRA-QURAN/main/hajj_live.json';
  ...
  static const String embedParams =
      '?autoplay=1&controls=0&modestbranding=1&rel=0&fs=0&disablekb=1&iv_load_policy=3&playsinline=1';
  ...
  static const String errorBody =
      "We are experiencing technical difficulties connecting to the live stream. Our team has been notified.";

  static const String allFailedTitle = "Unable to Connect";
  static const String allFailedBody =
      "We were unable to connect to the live stream after several attempts. Please check your internet connection or try watching directly.";
