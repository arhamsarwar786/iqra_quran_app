          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _sectionCard(
                  bloc: bloc,
                  title: 'Islamic Calendar Adjustment',
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      RichText(
                          ...
                          child: Center(
                            child: TextButton(
                              onPressed: () async {
                                ...
                                // Re-trigger auto detection by reloading prayer data or similar
                                // For now, we just clear the manual flag and the next location check will fix it.
                                bloc.getHijriOffset();
                                setState(() {});
                              },
