...
class _PermissionScreenState extends State<PermissionScreen> {
  ...
  Future<void> _requestPermissions() async {
    ...
    if (!_audioGranted) {
      ...
      if (mounted) setState(() => _audioGranted = status.isGranted);
    }
  }
  ...
  void _handleGetStarted() {
    if (_locationGranted) {
      ...
      snackBar(context, "Location permission is required for Prayer Times");
      _requestPermissions(); // Re-prompt if they try to proceed without it
    }
  }
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      _locationGranted ? "GET STARTED" : "ALLOW ACCESS",
                      style: TextStyle(
                        color: const Color(0xff0E323F),
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        letterSpacing: 1.2,
                      ),
